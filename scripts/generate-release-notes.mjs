...
const prompt = [
  ...
  `Do not repeat the same update in multiple sections.`,
  `Each bullet must describe a unique change.`,
  ...
  `Use at most 2 bullets per section, and only when necessary.`,
  `Keep each bullet to one short sentence.`,
  `Never list raw commit hashes or duplicate ideas.`,
